    ...
    return (
       <div className="flex min-h-screen">
        ...
        <div className="flex items-center text-center justify-center w-full gap-10">
            ...
            <form onSubmit={handleAdmin}  className="flex flex-col gap-4 bg-white p-6 rounded shadow-md">
            <h1 className="text-2xl font-semibold text-gray-700">Admin Login</h1>
                ...
                <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition" >Login</button>
